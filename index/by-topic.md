...
| [2026-04-24](../reports/2026/04/2026-04-24.md) | **特集**：音響メタマテリアル — 構造で音を操る次世代技術（ゴーストトンネル、iwasemi OC-β、LLM駆動設計） | 音響メタマテリアル, 吸音技術, スピーカー設計, 騒音制御, LLM駆動設計, iwasemi, PixieDustTechnologies, KEF, MAT, ゴーストトンネル, 3Dプリント, 低周波吸音 |
## 超指向性音響・パラメトリックスピーカー

| 日付 | テーマ | タグ |
|------|--------|------|
| [2026-03-27](../reports/2026/03/2026-03-27.md) | **特集**：超指向性音響・パラメトリックスピーカー技術の最前線2026：音を「光のように絞る」技術がオフィス・PA・ANCを変革する | パラメトリックスピーカー, 超指向性音響, 指向性スピーカー, パラメトリックアレイ, Audfly, Holoplot, Focusonics, Holosonics, 超音波変調, パーソナルサウンドゾーン, ANC, NTT空間ANC, デジタルサイネージ, オフィス音響, 博物館音響 |
| [2026-03-27](../reports/2026/03/2026-03-27.md) | （関連）Audfly Focus Aura（ISE 2026）, Holoplot X1 Sphere Las Vegas 1,600モジュール, NTT空間ANC 2マイクロ秒GPU処理・2026年度商用展開, SPPAL論文（JASA 2025）段付き板単一ランジュバン振動子 | Audfly, Focus Aura, Holoplot, X1, NTT, 空間ANC, SPPAL, JASA, Ericsson, MPEG-I, パーソナルサウンドゾーン |
...
| [2026-05-14](../reports/2026/05/2026-05-14.md) | **特集**：MEMSスピーカー量産元年2026：xMEMS Cypress/Sycamore商用出荷とNature誌FOM理論・Push-Pull駆動が拓くシリコン振動板の新時代 | MEMS スピーカー, xMEMS, Cypress, Sycamore, Sycamore-W, 圧電MEMS, PiezoMEMS, シリコン振動板, Rayking, Alta-S, TWS イヤホン, AIウェアラブル, スマートウォッチ, 量産, Figure of Merit, Nature Microsystems, Push-Pull駆動, ScAlN |
| [2026-05-14](../reports/2026/05/2026-05-14.md) | （関連）鹿島建設OPSODIS 1一般販売開始（クロストークキャンセル立体音響・CF9.2億円）, AES Europe 2026コペンハーゲンDTU開催, Bio-inspired音響メタマテリアルML駆動設計, Pro Audio Technologyベストセラー5機種アップグレード | 鹿島建設, OPSODIS 1, クロストークキャンセル, サウサンプトン大学, AES Europe 2026, DTU, Geoff Martin, Bio-inspired メタマテリアル, 機械学習, UPV RIR DB |
...
| 日付 | テーマ | タグ |
|------|--------|------|
| [2026-03-18](../reports/2026/03/2026-03-18.md) | （関連）KEF MAT普及, LLM活用自動設計, Pixie Dust Technologies | 音響メタマテリアル, KEF MAT, LLM設計 |
...
| 日付 | テーマ | タグ |
|------|--------|------|
| [2026-03-18](../reports/2026/03/2026-03-18.md) | Klippel FLSI Pro：LPM+LSI統合、Bl(x)・Le(f,x,i)・Sd(x)・ポート非線形識別 | FLSI, 非線形歪み, Klippel, グレーボックスモデリング, 磁気モード |
...
| [2026-05-16](../reports/2026/05/2026-05-16.md) | **特集**：パッシブスピーカーのワイヤレス化革命 — Pro-Ject Wireless Box E×WiiM OSが切り拓く「ケーブルレスHi-Fi」の新地平 | Pro-Ject, Wireless Box E, Stream Box E, WiiM OS, パッシブスピーカー, ワイヤレス化, ストリーミング, マルチルーム, Jamo, Concert Legacy, Concert Element, Scan-Speak, SEAS, High End Vienna, Sennheiser, AMBEO, MEMS圧電スピーカー, Double-Sアクチュエータ, FaitalPro |
| [2026-05-16](../reports/2026/05/2026-05-16.md) | （関連）Pro-Ject Wireless Box E €229 WiiM OS搭載25Wモノラルストリーミングアンプ（5月下旬発売）, Jamo Concert Legacy/Element High End Vienna 2026発表（Scan-Speak/SEAS協業・8月発売）, Sennheiser AMBEO 2ch Broadcast Renderer NAB 2026, Double-Sアクチュエータ MEMS SPL+23dB THD<0.6%, Push-pull MEMS 109.5dB, FaitalPro 21XL3000 21インチサブウーファー | Pro-Ject, WiiM, Jamo, Scan-Speak, SEAS, Sennheiser, AMBEO, MEMS, PZT, FaitalPro |
...
| [2026-04-30](../reports/2026/04/2026-04-30.md) | **特集**：Bluetooth LE Audio / Auracast / HDT革命2026 — パッシブスピーカー無線化からロスレス・マルチチャンネルまで | Bluetooth LE Audio, Auracast, Bluetooth 6.0, HDT, High Data Throughput, LC3plus, Pro-Ject, Wireless Box E, WiiM, Samsung, Music Studio, Marshall, Emberton III, Willen II, ワイヤレスオーディオ, パッシブスピーカー, マルチルーム, ロスレス, コーデック, Bluetooth SIG, LD Systems, ICOA PRO, BEM最適化, Sonarion, NEG, ガラス振動板 |
